...
**		Function require extensive argument checking thus longer
**		than 50 lines. Since the argument checking process is
**		unique to this function alone, breaking down into smaller
**		function was deemed unecessary.
*/
...
**		Function require extensive board checking thus longer
**              50 lines. Some of the checking process has been broken
**            	down into smaller functions since they are used elsewhere
**            	in the program. The argument check left in this function
**		are not used by other functions in the program thus further
**		breakdown was deemed unnecessary.
*/
